#Use this data source to access the configuration of the AzureRM provider. You can get client_id, tenant_id, subscription_id and object_id
...
resource "azurerm_app_service_plan" "main" {
  ...
  name                = coalesce(local.plan.name, local.default_plan_name) #takes any number of arguments and returns the first one that isn't null or an empty string.
